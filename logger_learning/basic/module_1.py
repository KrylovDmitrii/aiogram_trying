# import logging
#
# from logger_learning.module_2 import devide_number
# from logger_learning.module_3 import square_number
#
...
# error_file = logging.FileHandler('logger_learning/error.log', 'w', encoding='utf-8')
